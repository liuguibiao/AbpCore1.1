...
(function () {
    ...
    function startConnection(url, configureConnection) {
        return function start(transport) {
            //abp.log.debug(`Starting connection using ${signalR.TransportType[transport]} transport`); //ie不支持
            ...
            return connection.start()
                ...
                .catch(function (error) {
                    //abp.log.debug(`Cannot start the connection using ${signalR.TransportType[transport]} transport. ${error.message}`);  //ie不支持
