...
using AbpCore.Project.Identity;
using AbpCore.Project.MultiTenancy;
using AbpCore.Project.Sessions;
using AbpCore.Project.Web.Models.Account;
using AbpCore.Project.Web.Views.Shared.Components.TenantChange;
    ...
    public class AccountController : ProjectControllerBase
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            try
            {
                ...
                {
                    AbpLoginResult<Tenant, Authorization.Users.User> loginResult;
                    if (externalLoginInfo != null)
                    {
        ...
        {
            List<Authorization.Users.User> allUsers;
