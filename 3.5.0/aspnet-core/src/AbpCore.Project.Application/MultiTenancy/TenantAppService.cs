...
using AbpCore.Project.Editions;
...
namespace AbpCore.Project.MultiTenancy
{
    ...
    public class TenantAppService : AsyncCrudAppService<Tenant, TenantDto, int, PagedResultRequestDto, CreateTenantDto, TenantDto>, ITenantAppService
    {
        ...
        private readonly IPasswordHasher<Authorization.Users.User> _passwordHasher;
        ...
        public TenantAppService(
            ...
            IPasswordHasher<Authorization.Users.User> passwordHasher) 
            : base(repository)
        {
        ...
        public override async Task<TenantDto> Create(CreateTenantDto input)
        {
            ...
            using (CurrentUnitOfWork.SetTenantId(tenant.Id))
            {
                ...
                adminUser.Password = _passwordHasher.HashPassword(adminUser, Authorization.Users.User.DefaultPassword);
